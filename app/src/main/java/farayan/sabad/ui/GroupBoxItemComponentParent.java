...
public abstract class GroupBoxItemComponentParent extends SabadBaseComponent {
	...
	protected static final String tag = "GroupBoxItemComponentParent";
	...
	private void LoadLayout(Context context) {
		...
		rootView = inflater.inflate(R.layout.group_box_item, this);
		long finish = System.currentTimeMillis();
		Log.i("Performance", String.format("inflating group_box_item takes %s milliseconds", FarayanUtility.MoneyFormatted(finish - start, false)));
	...
	public GroupBoxItemComponentParent(Context context) {
		super(context);
		LoadLayout(context);
		InitializeLayout();
	}

	public GroupBoxItemComponentParent(Context context, AttributeSet attrs) {
		super(context,attrs);
		LoadLayout(context);
		InitializeLayout(attrs);
	}

	public GroupBoxItemComponentParent(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		LoadLayout(context);
		InitializeLayout(attrs, defStyle);
	}

	public GroupBoxItemComponentParent(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
