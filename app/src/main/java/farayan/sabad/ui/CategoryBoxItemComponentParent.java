...
public abstract class CategoryBoxItemComponentParent extends SabadBaseComponent {
	private View rootView = null;

	protected static final String tag = "CategoryBoxItemComponentParent";
	...
	private void LoadLayout(Context context) {
		...
		rootView = inflater.inflate(R.layout.category_box_item, this);
		long finish = System.currentTimeMillis();
		Log.i("Performance", String.format("inflating category_box_item takes %s milliseconds", FarayanUtility.MoneyFormatted(finish - start, false)));
	...
	public CategoryBoxItemComponentParent(Context context) {
		super(context);
		LoadLayout(context);
		InitializeLayout();
	}

	public CategoryBoxItemComponentParent(Context context, AttributeSet attrs) {
		super(context,attrs);
		LoadLayout(context);
		InitializeLayout(attrs);
	}

	public CategoryBoxItemComponentParent(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		LoadLayout(context);
		InitializeLayout(attrs, defStyle);
	}

	public CategoryBoxItemComponentParent(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
