...
public abstract class ProductBoxItemComponentParent extends SabadBaseComponent {
	private View rootView = null;

	protected static final String tag = "ProductBoxItemComponentParent";
	...
	private void LoadLayout(Context context) {
		...
		rootView = inflater.inflate(R.layout.product_box_item, this);
		long finish = System.currentTimeMillis();
		Log.i("Performance", String.format("inflating product_box_item takes %s milliseconds", FarayanUtility.MoneyFormatted(finish - start, false)));
	...
	public ProductBoxItemComponentParent(Context context) {
		super(context);
		LoadLayout(context);
		InitializeLayout();
	}

	public ProductBoxItemComponentParent(Context context, AttributeSet attrs) {
		super(context,attrs);
		LoadLayout(context);
		InitializeLayout(attrs);
	}

	public ProductBoxItemComponentParent(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		LoadLayout(context);
		InitializeLayout(attrs, defStyle);
	}

	public ProductBoxItemComponentParent(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
